...
export default defineComponent({
  ...
  methods: {
    ...
    getCurrencies(){
      ...
      axios.get('https://lnbits1.apfelblitz.de/api/v1/currencies', {headers})
        .then(response => {
    ...
    openTPos(){
      ...
      window.open(`https://lnbits1.apfelblitz.de/tpos/${this.selected_tpo.id}`, '_blank');
      this.selected_tpo = ''
    },
    getTPOS(){
      let headers = {
      ...
      axios.get('https://lnbits1.apfelblitz.de/tpos/api/v1/tposs', {headers})
        .then(response => {
    ...
    async fetchTransactions() {
      ...
      axios.get('https://lnbits1.apfelblitz.de/api/v1/payments', {headers, params})
        .then(response => {
